...
# export PYTORCH_ROCBLASLT_FORCE_DISABLED=1      # (PyTorch honors this var)
# export HIPBLASLT_FORCE_TUNING=0                # reduce algo-tuning excursions

# export ROCBLAS_LAYER=1
# export ROCBLAS_LOG_PATH=/tmp/rocblas_trace.txt
